                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="90%">
                      <tbody class="black10">
                        <tr>
                          <td class="btn_parent">
                             <router-link to="/">
                              <button class="btn btn_child shadow" type="button" id="btn1" value="2D ILLUSTRATED">2D ILLUSTRATED</button>
                            </router-link>
                            <router-link to="/3d">
                              <button class="btn btn_child shadow" type="button" id="btn2" value="3D PHOTOFACE">3D PHOTOFACE</button>
                            </router-link>
                            <router-link to="/fb">
                              <button class="btn btn_child shadow btn1" type="button" id="btn3" value="FULL BODY">FULL BODY</button>
                            </router-link>
                  ...
                  <td align="center">
                    <table cellpadding="10" cellspacing="0" border="0" width="350">
                      <tbody>
                        ...
                        <tr>
                          <td colspan="2" align="center">
                             <SitePal embed='5626448,420,280,"",1,1,2624414,0,1,1,"6e24865e0ec56e20b3b1eea1577e2a7b",0'/>
                          </td>
                        </tr>
                        <tr>
                        </tr>
